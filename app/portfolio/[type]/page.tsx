...
export default function TypePortfolioPageWithSidebar() {
  return <div className="with-sidebar"><Sidebar /><div className="page-content"><TypePortfolioPage /></div></div>;
}

function TypeDetail({ current, reports }: { current?: PortfolioProject; reports: (typeof reportsByProject)[string] }) {
