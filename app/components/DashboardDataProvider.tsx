...
type DashboardData = { projects: PortfolioProject[]; reportsByProject: FlashMap; changes: ChangeRecord[]; snapshotDate: string; snapshots: ProjectSnapshot[]; applySnapshot: (projects: PortfolioProject[], reports: FlashMap, snapshotDate: string) => void; restoreSnapshot: (date: string) => void };
